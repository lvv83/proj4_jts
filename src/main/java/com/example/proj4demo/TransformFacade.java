...
public class TransformFacade {
	...
	private final CoordinateReferenceSystem wgs84_crs = crsFactory.createFromParameters("WGS84",
	...
	private final CoordinateReferenceSystem msk11q4_crs = crsFactory.createFromParameters("MSK11_Q4",
			KnownProjStrings.P42_MSK11_Q4);
	private final CoordinateReferenceSystem msk11q5_crs = crsFactory.createFromParameters("MSK11_Q5",
			KnownProjStrings.P42_MSK11_Q5);
	private final CoordinateReferenceSystem msk11q6_crs = crsFactory.createFromParameters("MSK11_Q6",
			KnownProjStrings.P42_MSK11_Q6);

	private final CoordinateTransform wgs84_p42_transform = coordinateTransformFactory.createTransform(wgs84_crs,
			p42_crs);
	private final CoordinateTransform p42_wgs84_transform = coordinateTransformFactory.createTransform(p42_crs,
			wgs84_crs);
	private final CoordinateTransform msk11q4_wgs84_transform = coordinateTransformFactory.createTransform(msk11q4_crs,
			wgs84_crs);
	private final CoordinateTransform msk11q5_wgs84_transform = coordinateTransformFactory.createTransform(msk11q5_crs,
			wgs84_crs);
	private final CoordinateTransform msk11q6_wgs84_transform = coordinateTransformFactory.createTransform(msk11q6_crs,
			wgs84_crs);
