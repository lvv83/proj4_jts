...
public class ApplicationConfig {
	...
	Map<KnownTransformation, CoordinateTransform> knownTransformations(
		...
		map.put(KnownTransformation.MSK11_Q4_WGS84, factory.createTransform(knownCRS.get("MSK11_Q4"), knownCRS.get("WGS84")));
		map.put(KnownTransformation.MSK11_Q5_WGS84, factory.createTransform(knownCRS.get("MSK11_Q5"), knownCRS.get("WGS84")));
		map.put(KnownTransformation.MSK11_Q6_WGS84, factory.createTransform(knownCRS.get("MSK11_Q6"), knownCRS.get("WGS84")));
